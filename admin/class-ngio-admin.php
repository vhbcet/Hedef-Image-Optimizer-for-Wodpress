                ...
                <div class="ngio-settings-grid">
                    ...
                    <section class="ngio-card ngio-card-server">
                        ...
                        <div class="ngio-card-body">
                            ...
                            <p class="description">
                                <?php
                                echo esc_html__( 'If Imagick shows as unavailable in the server support table, you need to install the Imagick PHP extension on your server. Hedef Hosting servers support Imagick, so enabling it should be straightforward.', 'nextgen-image-optimizer' );
                                ?>
                            </p>
                        </div>
                    </section>
